...
enum AccountTypes
{
    SEC_S_TESTER		   = 4,
	SEC_S_VIP			   = 5,
	SEC_S_TICKETMASTER     = 6,
	SEC_S_EVENTMASTER      = 7,
	SEC_S_GAMEMASTER	   = 8,
	SEC_S_HEADGAMEMASTER   = 9,
	SEC_S_DEVELOPER		   = 10,
	SEC_S_HEADDEVELOPER	   = 11,
	SEC_S_ADMINISTRATOR    = 12,
	SEC_S_OWNER			   = 13,
    ...
    SEC_GAMEMASTER     = 2,
    SEC_ADMINISTRATOR  = 3,
    SEC_CONSOLE        = 20                                  // must be always last in list, accounts must have less security level always also
};
