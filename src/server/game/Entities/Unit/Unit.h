...
class TC_GAME_API Unit : public WorldObject
{
    public:
        ...
        void GetFriendlyUnitListInRange(const WorldObject* obj, std::list<Unit*> &list, float fMaxSearchRange) const;
        void GetAttackableUnitListInRange(const WorldObject* obj, std::list<Unit*> &list, float fMaxSearchRange) const;
        ...
        bool IsImmunedToMechanic(uint32 mechanic) const;
        bool IsPermanentlyImmunedToMechanic(uint32 mechanic) const;
        ...
        uint32 GetLastSpellIDUsed() { return m_lastSpellIDUsed; }
        void SetLastSpellIDUsed(uint32 lastSpellID) { m_lastSpellIDUsed = lastSpellID; }
        uint32 m_lastSpellIDUsed;
        uint8 m_lastSpellIDUsedCount;
