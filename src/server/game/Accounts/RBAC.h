...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_ANTICHEAT                              = 1002,
    RBAC_PERM_COMMAND_ANTICHEAT_GLOBAL                       = 1003,
    RBAC_PERM_COMMAND_ANTICHEAT_PLAYER                       = 1004,
    RBAC_PERM_COMMAND_ANTICHEAT_HANDLE                       = 1005,
    RBAC_PERM_COMMAND_ANTICHEAT_DELETE                       = 1006,
    RBAC_PERM_COMMAND_ANTICHEAT_JAIL                         = 1007,
    RBAC_PERM_DONT_APPLY_ANTICHEAT                           = 1008,
