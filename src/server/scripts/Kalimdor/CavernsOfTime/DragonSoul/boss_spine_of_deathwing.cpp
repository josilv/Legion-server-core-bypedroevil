            ...
            void MovementInform(uint32 type, uint32 id) override
            {
                if (type == POINT_MOTION_TYPE)
                    if (id == POINT_SPAWNER)
                    {
                        ...
                        me->SetSpeedRate(MOVE_SWIM, 1.0f);
            ...
            void DamageTaken(Unit* /*who*/, uint32 & damage) override
            {
                if (me->GetHealth() < damage)
                {
                    ...
                    if (!isDead)
                    {
                        ...
                        me->SetSpeedRate(MOVE_RUN, 0.05f);
                        me->SetSpeedRate(MOVE_SWIM, 0.05f);
                        me->SetSpeedRate(MOVE_WALK, 0.05f);
                        me->SetSpeedRate(MOVE_FLIGHT, 0.05f);
