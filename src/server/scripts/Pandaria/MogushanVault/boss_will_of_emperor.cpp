                ...
                switch(events.ExecuteEvent())
                {
                    ...
                    case EVENT_DEVASTATING_COMBO:
                    {
                        ...
                        if (!devastatingComboPhase)
                        {
                            ...
                            // Set Turning Speed
                            me->SetSpeedRate(MOVE_TURN_RATE, 10.0f);
                            me->SetSpeedRate(MOVE_WALK, 0.0f);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                // Reset next combo
                                devastatingComboPhase = 0;
                                me->SetSpeedRate(MOVE_TURN_RATE, moveTurn);
                                me->SetSpeedRate(MOVE_WALK, moveWalk);
                                me->SetSpeedRate(MOVE_RUN, moveRun);
